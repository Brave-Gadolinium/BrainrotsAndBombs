...
PlaytimeRewardConfiguration.Rewards = {
	...
	[2] = { Id = 2, RequiredSeconds = 2 * 60, Type = "Money", Amount = 1000, Image = MONEY_IMAGE } :: RewardEntry,
	[3] = { Id = 3, RequiredSeconds = 4 * 60, Type = "Money", Amount = 1500, Image = MONEY_IMAGE } :: RewardEntry,
	[4] = { Id = 4, RequiredSeconds = 6 * 60, Type = "Money", Amount = 2500, Image = MONEY_IMAGE } :: RewardEntry,
	...
	[6] = { Id = 6, RequiredSeconds = 11 * 60, Type = "Money", Amount = 5000, Image = MONEY_IMAGE } :: RewardEntry,
	[7] = { Id = 7, RequiredSeconds = 14 * 60, Type = "Money", Amount = 10000, Image = MONEY_IMAGE } :: RewardEntry,
	[8] = { Id = 8, RequiredSeconds = 17 * 60, Type = "Money", Amount = 15000, Image = MONEY_IMAGE } :: RewardEntry,
	...
	[10] = { Id = 10, RequiredSeconds = 23 * 60, Type = "Money", Amount = 25000, Image = MONEY_IMAGE } :: RewardEntry,
	[11] = { Id = 11, RequiredSeconds = 26 * 60, Type = "Money", Amount = 50000, Image = MONEY_IMAGE } :: RewardEntry,
